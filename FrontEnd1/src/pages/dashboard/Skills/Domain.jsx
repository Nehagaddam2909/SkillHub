...
return(
  <div className="w-[12rem]">
    <div key={idx} className={`flex items-center justify-center shadow-lg rounded-xl h-16 w-[12rem] text-blue-600  border-2 border-purple-500 ${domain===ele?"bg-white":" bg-gray-100"}`}>
